...
class ManageDrugComponent extends Component {
    ...
    saveOrUpdateDrug = (d) => {
        ...
        else if(this.state.unitPrice === ''){alert("Unit Price is Required!")}
        else if(this.state.quantity === ''){alert("Quantity is Required!")}
        else if(this.state.manuDate === ''){alert("Manufacture Date is Required!")}
        else if(this.state.expDate === ''){alert("Expiry Date is Required!")}
        else if(this.state.bufferStock === ''){alert("Buffer Stock is Required!")}
        else{
            if(this.state.drugId === 'add'){
                            ...
                            <div className = "card-body">
                                <form>
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <input placeholder = "Buffer Stock" name = "bufferStock" className = "form-control" value = {this.state.bufferStock} onChange = {this.changeBufferStockHandler}/>
                                    </div>
                                    <div className = "form-group">
